...
semljsynOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    ...
    public = list(
        initialize = function(
            ...
            outputCombineCovariances = FALSE,
            cov.lv = FALSE,
            ...
            private$..icc <- jmvcore::OptionBool$new(
                ...
                icc,
                default=TRUE)
            private$..mlmeans <- jmvcore::OptionBool$new(
                "mlmeans",
                mlmeans,
                default=FALSE)
            ...
            private$..outputResidualCovariances <- jmvcore::OptionBool$new(
                ...
                outputResidualCovariances,
                default=FALSE)
            private$..outputCombineCovariances <- jmvcore::OptionBool$new(
                "outputCombineCovariances",
                outputCombineCovariances,
                default=FALSE)
            ...
            self$.addOption(private$..outputCombineCovariances)
    ...
    active = list(
        ...
        outputCombineCovariances = function() private$..outputCombineCovariances$value,
                ...
                public=list(
                    ...
                    "eq_lv.covariances"))
                        self$add(jmvcore::Table$new(
                            ...
                            visible="(outputObservedCovariances & !outputCombineCovariances)",
                            clearWith=list(
                                "code",
                                "estimator",
                                "likelihood",
                        ...
                        self$add(jmvcore::Table$new(
                            ...
                            clearWith=list(
                                ...
                                "eq_lv.variances",
                                "eq_lv.covariances"),
                            visible="(outputImpliedCovariances & !outputCombineCovariances)",
                            columns=list(
                                list(
                                    `name`="lgroup", 
                                    `title`="Group", 
                        ...
                        self$add(jmvcore::Table$new(
                            ...
                            visible="(outputResidualCovariances & !outputCombineCovariances)",
                            clearWith=list(
                                "code",
                                "estimator",
                                "likelihood",
...
#'   (manifest) variables.
#' @param outputCombineCovariances \code{TRUE} or \code{FALSE} (default),
...
semljsyn <- function(
    ...
    options <- semljsynOptions$new(
        ...
        outputCombineCovariances = outputCombineCovariances,
        cov.lv = cov.lv,
