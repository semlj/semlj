...
semljsynOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "semljsynOptions",
        inherit = jmvcore::Options,
        public = list(
            initialize = function(.caller = "syntax",
                                  code = "",
                                  syntax = "",
                                  fonts = "small",
                                  vars = list(),
...
semljsynResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "semljsynResults",
...
semljsynBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "semljsynBase",
