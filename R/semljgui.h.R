...
semljguiOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "semljguiOptions",
        inherit = jmvcore::Options,
        public = list(
            initialize = function(.caller = "gui",
                                  code = "",
                                  donotrun = NULL,
                                  endogenous = list(
...
semljguiResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "semljguiResults",
...
semljguiBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "semljguiBase",
